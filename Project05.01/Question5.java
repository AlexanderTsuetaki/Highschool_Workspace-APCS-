/**
 * This program calculates the answer to question 5 for the Appalachian Trail Group Project
...
public class Question5 {
	...
	/**
	 * Constructor for the Question5 class
	...
	/**
	 * Calculates the 100-mile section of the trail that can be determined to be the "lest challenging" section of the trail
	 * @return the 100-mile section of the trail that can be determined to be the "lest challenging" section of the trail
	 */
	private double[] calculate(){
		...
		for(int q = 0; q < 284870; q++){
			...
			if(minAverageGrade > averageGrade){
		...
		return new double[] {minAverageGrade * 100, startMile, endMile};
	}
	
	/**
	 * Main method for class Question5. The entry point.
